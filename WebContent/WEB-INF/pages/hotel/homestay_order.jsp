            ...
            <div class="col insideBorder">
                ...
                <div>
                    <div>
                        <div style="float: left;box-shadow:0px 3px 3px 3px #cccccc;">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <img src="img/hotel_image/d4940929.jpg" class="card-img-top" style="width:400px;height:350px;"
                        ...
                        <span
                            ...
                            <br>
                            <br>
                            <span style="font-weight: bold;">${countStarNum }/5</span> 太讚了 (${hotelMomentNum }則評論)
                            <br>旅客給了住宿清潔度 ${countStarNum }/5 的評價。
                            <br>
                            <br>
                    ...
                    <div style="float: left;">
                        ...
                        <input class="input_control" type="text" value="${loginOK.tel }"  readonly>
                        
                        <br>
						<label style="font-size: 1.3rem;line-height: 1.4;color: #616161;font-weight: 700;">Ｍａｉｌ：</label>
                        <input class="input_control" type="text" value="${loginOK.email }" style="width:300px;margin-right:450px;"  readonly>
                        <c:choose>
                        <c:when test="${howmanyPeopleSee.seeoverhotel!=0 }">
                        <span style="font-zise:20px;font-weight:700;position:absolute;right:20px;bottom:-50px;">目前下訂過此房的人數：<span style="color:red;font-weight:900;font-size:36px;">${howmanyPeopleSee.seeoverhotel }</span></span>
                        </c:when>
                        <c:when test="${howmanyPeopleSee.seeoverhotel==0 || empty howmanyPeopleSee.seeoverhotel }">
